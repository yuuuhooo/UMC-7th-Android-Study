...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  private ActivitySecondBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textSecond) {
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.text_second;
      TextView textSecond = ViewBindings.findChildViewById(rootView, id);
      if (textSecond == null) {
        break missingId;
      }

      return new ActivitySecondBinding((ConstraintLayout) rootView, textSecond);
    }
