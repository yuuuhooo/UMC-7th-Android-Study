...
public final class ActivitySongBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView songAlbumCv;
  ...
  private ActivitySongBinding(@NonNull ConstraintLayout rootView, @NonNull CardView songAlbumCv,
      @NonNull ImageView songAlbumIv, @NonNull ImageButton songDownIb,
      @NonNull TextView songEndTimeTv, @NonNull ImageButton songEqIb,
      @NonNull ImageView songInstagramIv, @NonNull ImageView songLikeIv,
      @NonNull LinearLayout songLikeIvLayout, @NonNull ImageView songListIv,
      @NonNull ImageView songMiniplayerIv, @NonNull ImageButton songMoreIb,
      @NonNull TextView songMusicLyrics01Iv, @NonNull TextView songMusicLyrics02Iv,
      @NonNull TextView songMusicTitleTv, @NonNull ImageView songNextIv,
      @NonNull ImageView songPauseIv, @NonNull LinearLayout songPlayerLayout,
      @NonNull ImageView songPreviousIv, @NonNull SeekBar songProgressSb,
      @NonNull ImageView songRandomIv, @NonNull ImageView songRelatedIv,
      @NonNull ImageView songRepeatIv, @NonNull ImageButton songSettingIb,
  ...
  public static ActivitySongBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.song_album_cv;
      CardView songAlbumCv = ViewBindings.findChildViewById(rootView, id);
      if (songAlbumCv == null) {
        break missingId;
      }
      ...
      return new ActivitySongBinding((ConstraintLayout) rootView, songAlbumCv, songAlbumIv,
          songDownIb, songEndTimeTv, songEqIb, songInstagramIv, songLikeIv, songLikeIvLayout,
          songListIv, songMiniplayerIv, songMoreIb, songMusicLyrics01Iv, songMusicLyrics02Iv,
          songMusicTitleTv, songNextIv, songPauseIv, songPlayerLayout, songPreviousIv,
          songProgressSb, songRandomIv, songRelatedIv, songRepeatIv, songSettingIb,
          songSingerMoreIv, songSingerNameTv, songStartTimeTv, songUnlikeIv);
    }
